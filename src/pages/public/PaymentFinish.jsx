    ...
    <div className="max-w-md mx-auto px-4 py-16 text-center">
      <div className="bg-white border border-slate-100 rounded-xl shadow-sm px-6 py-8">
        ...
        <div className="flex flex-col gap-2 mt-2">
          <Link
            to="/user/transaksi"
            className="w-full px-4 py-2 rounded-full bg-primary-600 text-white text-xs font-medium hover:bg-primary-700"
          >
            Lihat Riwayat Transaksi
          </Link>
          <Link
            to="/user"
            className="w-full px-4 py-2 rounded-full border border-slate-200 text-xs text-slate-700 hover:bg-slate-50"
          >
